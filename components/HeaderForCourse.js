...
export default function HeaderForCourse({hide,fixed,redirect,token}) {
	...
	return (
			<div className={`w-full mx-auto px-4 py-2 md:py-2 fixed z-40 bg-gradient-to-r from-blue-500/70 to-purple-500/70 drop-shadow-xl top-0 ${hide ? "backdrop-blur-sm md:backdrop-blur-lg":""}`}>
